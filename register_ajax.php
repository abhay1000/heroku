  ...
  <script>
	...
	*/
	...
	function valCame()
	{
		...
		var re = /\D\w\D+\s\D\w\D+/;
		if(re.test(cname)==true)
		{
			hs_box.style.display = "none";
		...
		{
			hs_box.style.display = "block";
			hs_box.innerHTML = "Invalid Company Name";		
		}
	}
	...
	if(jpass.value==jcpass.value && jvemail.value!="")
	{
	...
	{
		alert_jb_pa.style.display = "block";
	}
	}
  </script>
</body>
